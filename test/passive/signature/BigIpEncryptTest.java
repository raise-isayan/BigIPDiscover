...
public class BigIpEncryptTest {
    ...
    public void testBigIpEncrypt_Req1() {
        ...
        List<BigIPIssueItem> bigIP1 = BigIPCookie.parseMessage(true, Util.getRawByte(req1));
        ...
        List<BigIPIssueItem> bigIP2 = BigIPCookie.parseMessage(true, Util.getRawByte(req2));
    ...
    public void testBigIpEncryptList_Req1() {
        System.out.println("BigIpEncrypt Req1");
        List<BigIPIssueItem> bigIP1 = BigIPCookie.parseDecryptList(true, "BIGipServer_aa_bb_cc=1677787402.36895.0000", 0);
        assertEquals("10.1.1.100:8080", bigIP1.get(0).getIPAddr());
        assertEquals(true, bigIP1.get(0).startsBIGipServer());

        List<BigIPIssueItem> bigIP2 = BigIPCookie.parseDecryptList(true, "aa_bb_cc=1677787402.36895.0000", 0);
        assertEquals("10.1.1.100:8080", bigIP2.get(0).getIPAddr());
        assertEquals(false, bigIP2.get(0).startsBIGipServer());
    }
    ...
    public void testBigIpEncrypt_Res1() {
        ...
        List<BigIPIssueItem> bigIP1 = BigIPCookie.parseMessage(false, Util.getRawByte(res1));
        assertEquals("10.1.1.100:8080", bigIP1.get(0).getIPAddr());
        assertEquals(true, bigIP1.get(0).startsBIGipServer());

        String res2 = String.format(RES_TEST_FMT, "aa_bb_cc=1677787402.36895.0000");
        List<BigIPIssueItem> bigIP2 = BigIPCookie.parseMessage(false, Util.getRawByte(res2));
        assertEquals("10.1.1.100:8080", bigIP2.get(0).getIPAddr());
        assertEquals(false, bigIP2.get(0).startsBIGipServer());
    }
    ...
    public void testBigIpEncrypt_Res10() {
        ...
        List<BigIPIssueItem> bigIP1 = BigIPCookie.parseMessage(false, Util.getRawByte(RES_TEST10_FMT));
        assertEquals("10.1.1.100:8080", bigIP1.get(0).getIPAddr());
    ...
    public void testBigIpEncrypt_Res11() {
        ...
        List<BigIPIssueItem> bigIP1 = BigIPCookie.parseMessage(false, Util.getRawByte(RES_TEST11_FMT));
        assertEquals("192.0.2.1:80", bigIP1.get(0).getIPAddr());
    ...
    public void testDecrypt() {
        ...
        String ip1 = BigIPCookie.decrypt("1677787402.36895.0000");
        ...
        String ip4 = BigIPCookie.decrypt("rd3o20010112000000000000000000000030o80");
    ...
    public void testDecrypt2() {
        ...
        String ip1 = BigIPCookie.decrypt("10.1.1.100");
        assertEquals(null, ip1);

        String ip2 = BigIPCookie.decrypt("192.0.2.1");
