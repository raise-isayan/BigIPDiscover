...
public class BigIPCookieTest {
    ...
    public void testBigIPCookie_Req1() {
        ...
        List<BigIPIssueItem> bigIP1 = BigIPCookieScan.parseHeader(true, StringUtil.getBytesRaw(req1));
        ...
        List<BigIPIssueItem> bigIP2 = BigIPCookieScan.parseHeader(true, StringUtil.getBytesRaw(req2));
    ...
    public void testBigIPCookie_Res1() {
        ...
        List<BigIPIssueItem> bigIP1 = BigIPCookieScan.parseHeader(false, StringUtil.getBytesRaw(res1));
        assertEquals("10.1.1.100:8080", bigIP1.get(0).getIPAddr());
        assertEquals(true, bigIP1.get(0).startsBIGipServer());

        String res2 = String.format(RES_TEST_FMT, "aa_bb_cc=1677787402.36895.0000");
        List<BigIPIssueItem> bigIP2 = BigIPCookieScan.parseHeader(false, StringUtil.getBytesRaw(res2));
        assertEquals("10.1.1.100:8080", bigIP2.get(0).getIPAddr());
        assertEquals(false, bigIP2.get(0).startsBIGipServer());
    }
    ...
    public void testBigIPCookie_Res10() {
        ...
        List<BigIPIssueItem> bigIP1 = BigIPCookieScan.parseHeader(false, StringUtil.getBytesRaw(RES_TEST10_FMT));
        assertEquals("10.1.1.100:8080", bigIP1.get(0).getIPAddr());
    ...
    public void testBigIPCookie_Res11() {
        ...
        List<BigIPIssueItem> bigIP1 = BigIPCookieScan.parseHeader(false, StringUtil.getBytesRaw(RES_TEST11_FMT));
        assertEquals("192.0.2.1:80", bigIP1.get(0).getIPAddr());
